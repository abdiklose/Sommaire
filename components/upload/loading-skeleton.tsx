    ...
    >
      ...
      <div className="space-y-4">
        ...
        {[1, 2, 3].map((_, index) => (
          <div
            key={`numbered-${index}`}
            className="group relative bg-linear-to-br from-gray-500/[0.08] to-gray-600/[0.03] 
      ...
      >
        <div className="flex justify-between items-center">
          <Skeleton
            className="rounded-full w-12 h-12 bg-linear-to-br 
                       from-rose-500/50 to-rose-600/50"
          />
