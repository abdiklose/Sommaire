        ...
        <div className="text-center py-12 ">
            <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-gray-500 max-w-md">Upload your first PDF to get started with AI-Powered summaries.</p>
                    <Link href='/Upload'>
                            <Button variant={'link'} className="mt-4 text-white bg-linear-to-r from-rose-500 to-rose-700 hover:from-rose-600 hover:to-rose-900 hover:no-underline">Create Your First Summary</Button>
                    </Link>
                </div>
            </div>
    )
