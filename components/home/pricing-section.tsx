        ...
        >
          {paymentLink && (
            <Link
              href={paymentLink}
              className={cn(
                "w-full rounded-full flex items-center justify-center gap-2 bg-linear-to-br from-rose-800 to-rose-500 hover:from-rose-500 hover:to-rose-800 text-white border-2 py-2",
                id === "pro"
                  ? "border-rose-900"
