  ...
  return (
    ...
    >
      <MotionDiv
        ...
        className="relative p-[1px] overflow-hidden rounded-full bg-linear-to-r from-red-200 via-rose-500 to-rose-800 animate-gradient-x group"
      >
        <Badge
          variant={"secondary"}
      ...
      <MotionH1 variants={itemVariants} className="font-bold py-4 text-center">
        ...
        <span className="relative inline-block">
          ...
          <span
            className="absolute inset-0 bg-rose-200/500 -rotate-2 rounded-lg transform -skew-y-1"
            aria-hidden="true"
          ></span>
        </span>{" "}
        summaries
