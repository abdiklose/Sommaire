...
import { getSummaries, Summary as SummaryType } from "@/lib/summaries";
...
export default async function DashboardPage() {
  ...
  const summaries: SummaryType[] = await getSummaries(userId);
        ...
        <div className="px-2 py-12 sm:py-24">
          <div className="flex gap-4 mb-8 justify-between">
            <div className="flex flex-col gap-2">
              ...
              >
                Transformez vos PDF en informations concises et exploitables
              </MotionP>
            </div>
            {!hasReachedLimit && (
              <MotionDiv
